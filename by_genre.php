...
$searchQuery = "SELECT DISTINCT genre1 FROM products 
  ...
  <div class="home__container">
    ...
    <div class="genreContainer">
      ...
      while ($sortedGenre = mysqli_fetch_array($searchResults)) {
        ...
        if ($genreValue != 'null') {
          echo "<a href='#' class='genreButton' data-genre='$genreValue'>$genreValue</a>";
        }
      }
      ?>
    </div>
    ...
    <?php
    // foreach ($list as $distinct_genre) {
    //   echo "<p>" . $distinct_genre. "</p>";
    // }
    ?>
  </div>
</main>
